...
import { RefreshCw, Sparkles, Heart, MessageCircle, Youtube } from "lucide-react";
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center mb-4">
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600">Your 650 Method wellness companion is ready for you.</p>
          </div>
        </div>
        <motion.p
          initial={{ opacity: 0 }}
        ...
        <div className="flex flex-wrap gap-3 mt-6 ml-20">
          <Link href="/data-chat">
          ...
          <Link href="/youtube-feed">
            <Button variant="outline" className="border-vibrantPink text-vibrantPink hover:bg-vibrantPink/10">
              <Youtube className="mr-2 h-4 w-4" /> Mira's Videos
            </Button>
          </Link>
        </div>
      </div>
